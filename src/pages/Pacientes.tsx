      ...
      <main className="min-h-[calc(100vh-160px)] bg-white py-10 px-5 flex flex-col items-center">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl">
          {pacientes.map((p) => (
            ...
            >
              <div className="bg-[#7b4ce0] text-white rounded-full w-12 h-12 flex items-center justify-center font-semibold text-lg mb-4 group-hover:bg-blue-600 group-hover:text-white transition-all">
                {p.id}
              </div>
              <h2 className="text-xl font-semibold text-[#7b4ce0] group-hover:text-blue-700 transition-colors">
                {p.nome}
              </h2>
